# 📦 DEMO test-phase phase pack
Thank you for hosting your challenge on Grand-Challenge.org, we appreciate it!

## Content

This Phase Pack is a collection of tailored examples to help you
set up your test-phase phase for
[DEMO challenge](https://demo.grand-challenge.org/).


It contains the following:
* ️🦾 An example script to _automate uploading_ data to an archive
* 🦿 An example _submission algorithm_ that can be uploaded to run as a submission in this phase
...
Your test-phase phase uses the archive https://grand-challenge.org/archives/demo-challenge/.
...
**Note on GPU support:** The test scripts automatically detect whether NVIDIA GPU support
is available on your machine. If not (e.g. on macOS), the container will run on CPU instead.
This does not affect the exported container — on Grand Challenge your algorithm will always
have GPU access.
...
---
Generated by [Grand Challenge](https://grand-challenge.org/) (929230a)
